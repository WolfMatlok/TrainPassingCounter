...
void cGyroServer::processData()
{
  ...
  m_oAvgAccelX.SetValue(dBeschleunigung_xout_skaliert);
  m_oAvgAccelY.SetValue(dBeschleunigung_yout_skaliert);
  m_oAvgAccelZ.SetValue(dBeschleunigung_zout_skaliert);

  m_oAvgX.SetValue(getXRotation(dBeschleunigung_xout_skaliert, dBeschleunigung_yout_skaliert, dBeschleunigung_zout_skaliert));
  m_oAvgY.SetValue(getYRotation(dBeschleunigung_xout_skaliert, dBeschleunigung_yout_skaliert, dBeschleunigung_zout_skaliert));
