...
${OBJECTDIR}/FFTAnalyserResultHandlerBitmap.o: FFTAnalyserResultHandlerBitmap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/eigen3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FFTAnalyserResultHandlerBitmap.o FFTAnalyserResultHandlerBitmap.cpp

${OBJECTDIR}/MonitorSeismograph.o: MonitorSeismograph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/eigen3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonitorSeismograph.o MonitorSeismograph.cpp
...
${OBJECTDIR}/View/View.o: View/View.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/eigen3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/View/View.o View/View.cpp
